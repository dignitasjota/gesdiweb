---
title: 'Diseño web responsive y Mobile friendly'
excerpt: 'Diseño web responsive y Mobile friendlyContenido1 Diseño web responsive y Mobile friendly1.1 ¿Qué es el diseño responsive? 1.'
...
Con la llegada de las **nuevas tecnologías** y el aumento del uso de los dispositivos **móviles y tablets**, nos encontramos con un panorama muy diferente al que conocíamos. Ahora **las pantallas** ya no se limitan a unas medidas standard -13’’, 15’’ y 17’’- sino que **varían y cambian según el tamaño del smartphone** haciendo que haya una amplia gama de tamaños. Desde entonces, el uso y [**creación de páginas web**](/servicios/diseno-web 'Diseño de páginas web en Valencia') que sean **responsive**, es decir capaces de responder en cualquier dispositivo, e**s esencial y mejora la experiencia del usuario,** por eso google lo tiene cada vez lo tiene mas en cuenta en el [posicionamiento en dispositivos móviles](/servicios/posicionamiento-web), ya que hace bajar la tasa de rebote, aumentar el tiempo de permanencia en la web y ayuda fidelizar clientes.

[![Mobile Friendly](./imagenes/usabilidad-web-mobile-friendly/mobile-phones-300x236.jpg)](https://www.gesdiweb.es/wp-content/uploads/2015/03/mobile-phones.jpg)
...
[![Mobile Friendly](./imagenes/usabilidad-web-mobile-friendly/Mobile-friendly-website.jpg)](./imagenes/usabilidad-web-mobile-friendly/Mobile-friendly-website.jpg)

Aunque es cierto que **Google aún no está penalizando** seriamente con esto –aunque sí que lo tiene muy en cuenta a la hora de posicionar las webs- está dando toques de atención a través de Google Webmaster Tools para que las webs se empiecen a trabajar desde la perspectiva **responsive** y **Mobile Friendly,** de hecho el [**día 21 de abril google decía que penalizía a dispositivos móviles**](/blog/google-mobile-friendly-21-abril) (no tablets ni pc) las palabras claves de las webs que no se ajustarán a sus criterios, aunque esto no ha sido del todo cierto es preciso que cuanto antes te tomes en serio el tema de la **usabilidad web**
...
[![Mobile Friendly](./imagenes/usabilidad-web-mobile-friendly/Mobile-Friendly-141.jpg)](./imagenes/usabilidad-web-mobile-friendly/Mobile-Friendly-141.jpg)
