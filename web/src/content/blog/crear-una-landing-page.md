...
Las **landing pages son páginas de aterrizaje**, es decir, páginas a las que el usuario, por lo general, suele llegar haciendo click en algún link –sobre todo promocional-. Por lo general, suelen ser extensiones de este tipo de anuncios, textos o guías, donde realmente se explica la oferta del producto o servicio que se pretende ofrecer. **Es, básicamente una carta de ventas.**

Todas las landing pages deben estar optimizadas, es decir el usuario tiene que llegar a ella a través de palabras clave \`por campañas de PPC, posts relacionados etc, **no quiere decir que tengamos que hacer SEO a una landing page** (aunque se puede hacer lo veo perder el tiempo), porque su función no es posicionar si no convertir. De hecho en muchas ocasiones tienen carácter temporal por lo que posiblemente acabemos **[redireccionandolas con una 301](http://www.gastre.es/2016/09/sube-posiciones-en-las-serps-gracias-a-redireccion-301.html)**.

## Usos de las landings Pages

Son una muy buena forma de optimizar los resultados así como de medirlos. Otro uso que se **le puede dar a una landing page es el de ser un test para alguna campaña promocional (conocidos como test A/B)** –de un producto o servicio-. De este modo se mide el desempeño de las funciones de la idea, la imagen, la oferta y las posibilidades del producto.
...
Para mi sin duda el mejor herramienta para crear landings, se puede comprar por separado o comprar todos los temas de thive themes en un pack, si eres una agencia es una inversión necesaria.

Actualmente cuenta con **157 plantillas prediseñadas**, así que ya no tienes excusa para convertirte en una maquina de convertir leads xD

### [Wishpond](http://mbsy.co/dTGMR)

La **plataforma Wishpond** ofrece un editor “drag & drop” de landing pages mediante el cual podrás diseñar, de forma fácil e intuitiva, vistosas páginas de destino. Tendrás a tu disposición más de 50 plantillas ya optimizadas para conversiones, con la opción de realizar pruebas A/B desde la propia plataforma. _Se puede sincronizar con WordPress a través de su plugin_ y además ofrecen un **plan gratuito con un límite de 200 contactos**.
